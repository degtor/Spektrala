...
if __name__ == '__main__':
	...
	def __main__():	# main-funktion som skriver ut en enkel meny som forklarar vilka val anvandaren kan gora
		...
		place_objects = Process_data('geodataSW.txt') # Skapar en lista med objekt daer varje objekt representerar en plats fran geodata-filen
		...
		while True:
			...
			if user_input == '1':
				...
				place_objects.search_place(search_input) # Kallar pa search_place-metoden i Process_data-klassen som letar igeom alla objekt i place_objects-listan
			elif user_input == '2':
